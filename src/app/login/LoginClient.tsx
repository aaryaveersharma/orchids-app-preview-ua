  ...
  return (
    <div className="mobile-container bg-white text-black min-h-screen flex flex-col px-6 py-8">
      <div className="flex flex-col items-center mb-8 mt-10">
        ...
        <h1 className="text-xl font-black text-black mt-4 tracking-tighter uppercase">
          HASHTAG <span className="text-primary">GARAGE</span>
        </h1>
      </div>

      <h2 className="text-xl font-black text-black mb-1 text-center uppercase tracking-tight">Login</h2>
      <p className="text-gray-500 text-xs mb-8 text-center font-bold uppercase tracking-widest">Access your garage dashboard</p>
